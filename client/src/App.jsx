...
const AdminSettingsListPage = lazy(
  () => import("./pages/admin/settings/AdminSettingsListPage"),
);
const AdminSettingFormPage = lazy(
  () => import("./pages/admin/settings/AdminSettingFormPage"),
);
...
const FreelancerDiscoverPage = lazy(
  () => import("./pages/freelancer/FreelancerDiscoverPage"),
);
...
const ProtectedViewsDashboard = lazy(
  () => import("./pages/admin/protectedViews/ProtectedViewsDashboard"),
);
const ProtectedViewStatsPage = lazy(
  () => import("./pages/projects/ProjectViewStatsPage"),
);
            ...
            <Routes>
              ...
              <Route element={<ProtectedRoute />}>
                <Route element={<AppShell />}>
                  ...
                  <Route
                    element={
                      <ProtectedRoute requiredRoles={[ROLES.FREELANCER]} />
                    }
                  >
                    <Route
                      path="/discover"
                      element={<FreelancerDiscoverPage />}
                    />
                  ...
                  <Route
                    element={<ProtectedRoute requiredRoles={[ROLES.CLIENT]} />}
                  >
                    ...
                    <Route
                      ...
                      element={<FavoriteFreelancersPage />}
                    />
                    <Route
                      path="/projects/:id/stats"
                      element={<ProtectedViewStatsPage />}
                    />
                    <Route
                      path="/spending"
                      element={<ClientSpendingDashboard />}
                    />
                    <Route
                      path="/proposals"
                  ...
                  <Route
                    element={
                      <ProtectedRoute
                        requiredRoles={[ROLES.CLIENT, ROLES.FREELANCER]}
                      />
                    }
                  >
                  ...
                  >
                    <Route path="/admin" element={<AdminLayout />}>
                      ...
                      <Route
                        ...
                        element={<ProtectedViewsDashboard />}
                      />
                      <Route
                        path="ai-test"
                        element={<RecommendedProjectsTestPage />}
                      />
                      <Route
                        path="audit-logs"
